...
using Ursu_Alexandra_Lab2.Data;
using Ursu_Alexandra_Lab2.Models;

using System.Net.Http;
using System.Text;
using Newtonsoft.Json;

namespace Ursu_Alexandra_Lab2.Controllers
{
    public class CustomersController : Controller
    {
        private readonly LibraryContext _context;
        private string _baseUrl = "http://localhost:5138/api/Customers";
